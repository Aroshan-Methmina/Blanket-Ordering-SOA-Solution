<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SInventory.aspx.cs" Inherits="CozyComfortClient.Seller.SInventory" %>
...
<head runat="server">
    ...
    <title>Seller Inventory Management</title>
                ...
                <div class="table-data" style="margin-top: 30px;">
                    <div class="order">
                        ...
                        <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="False" 
                            CssClass="grid-view" DataKeyNames="SInventoryID"
                            ...
                            <Columns>
                                <asp:BoundField DataField="SInventoryID" HeaderText="ID" />

                                <asp:TemplateField HeaderText="Blanket Model">
                                    <ItemTemplate>
                                        <asp:Label ID="lblModel" runat="server" Text='<%# ((CozyComfortClient.Seller.SInventory)Page).GetModelName(Eval("SBlanketID")) %>'></asp:Label>
                                        <asp:HiddenField ID="hdnBlanketID" runat="server" Value='<%# Eval("SBlanketID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Material">
                                    <ItemTemplate>
                                        <%# ((CozyComfortClient.Seller.SInventory)Page).GetMaterialName(Eval("SBlanketID")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Quantity">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("SQuantity") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:BoundField DataField="SLastUpdated" HeaderText="Last Updated" DataFormatString="{0:g}" />
