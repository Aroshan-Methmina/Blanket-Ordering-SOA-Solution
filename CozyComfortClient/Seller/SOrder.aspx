<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOrder.aspx.cs" Inherits="CozyComfortClient.Seller.SOrder" %>
...
<head runat="server">
    ...
    <script>
        ...
        function updateDistributors() {
            ...
            const distributorDropdown = document.getElementById('<%= ddlDistributor.ClientID %>');
                ...
                <asp:Panel ID="pnlOrderForm" runat="server" Visible="false" CssClass="user-form">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlDistributor" runat="server" CssClass="form-control" 
                            DataTextField="DistributorName" DataValueField="DistributorId" 
                            AppendDataBoundItems="true" required Enabled="false">
                            <asp:ListItem Value="">Select Distributor</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                        ...
                        <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Distributor">
                                    <ItemTemplate>
                                        <%# GetDistributorName(Eval("DistributorId")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
