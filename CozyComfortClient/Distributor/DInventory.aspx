<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DInventory.aspx.cs" Inherits="CozyComfortClient.Distributor.DInventory" %>
...
<head runat="server">
    ...
    <title>Distributor Inventory Management</title>
                ...
                <div class="table-data" style="margin-top: 30px;">
                    <div class="order">
                        ...
                        <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="False" 
                            CssClass="grid-view" DataKeyNames="DInventoryID"
                            ...
                            <Columns>
                                <asp:BoundField DataField="DInventoryID" HeaderText="ID" />

                                <asp:TemplateField HeaderText="Blanket Model">
                                    <ItemTemplate>
                                        <asp:Label ID="lblModel" runat="server" Text='<%# GetModelName(Eval("DBlanketID")) %>'></asp:Label>
                                        <asp:HiddenField ID="hdnBlanketID" runat="server" Value='<%# Eval("DBlanketID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Material">
                                    <ItemTemplate>
                                        <%# GetMaterialName(Eval("DBlanketID")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Quantity">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("DQuantity") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:BoundField DataField="DLastUpdated" HeaderText="Last Updated" DataFormatString="{0:g}" />
